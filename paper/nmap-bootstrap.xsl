  ...
  <xsl:template match="/">
    <html lang="en">
      ...
      <body>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                <li><a href="#scannedhosts">受檢主機</a></li>
                <li><a href="#onlinehosts">在線主機</a></li>
                <li><a href="#openservices">開啟服務</a></li>
              </ul>
            </div>
          </div>
        </nav>
        <div class="container">
          <div class="jumbotron">
            <h1>主機服務檢測報告<br/><small>Nmap <xsl:value-of select="/nmaprun/@version"/></small></h1>
            <p class="lead"> 檢測時間：
              <xsl:value-of select="/nmaprun/@startstr"/> ～ <xsl:value-of select="/nmaprun/runstats/finished/@timestr"/><br/>總掃描數：
              <xsl:value-of select="/nmaprun/runstats/hosts/@total"/>, 　回應數：
              <xsl:value-of select="/nmaprun/runstats/hosts/@up"/>, 　無回應或離線數：
        ...
        <footer class="footer">
          <div class="container">
            <p class="text-muted">
		註：<br/>
		(1)CPE(Common Platform Enumeration)：為 Nmap 依系統回應訊息所猜測系統之可能資訊。<br/>
            </p>
          </div>
        </footer>
      </body>
